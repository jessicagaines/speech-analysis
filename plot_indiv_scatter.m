function[] = plot_indiv_scatter(stacked_f0,cond_values,adapt_size,tick_labels)
    ...
    saveas(fig,"multiple_pitch_adapt_figures/indiv_scatter",'fig');
    saveas(fig,"multiple_pitch_adapt_figures/indiv_scatter",'epsc');
end
